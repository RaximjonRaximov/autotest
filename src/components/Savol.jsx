...
const Savol = ({ text, timeLeft }) => {
  return (
    <div className="flex items-center justify-between text-white py-4 sm:py-[0.5rem] text-lg sm:text-[22px] font-bold px-2 sm:px-[1rem] bg-[#FFFFFF66] rounded-lg sm:rounded-[12px] mb-2 sm:mb-[1rem] gap-2">
